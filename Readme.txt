...
El archivo principal que se debe ejecutar es el "main.py" que hace uso de los demás archivos que se encuentran dentro de la carpeta src, entre ellos los correspondientes a los de extensión SQL que contienen el lenguaje de consulta para la creación de las tablas.
